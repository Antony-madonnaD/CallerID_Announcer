...
public class Speaker implements OnInitListener {
    ...
    IncomingCallService.ServiceHandler m_handler;
    ...
    public void speak(final String text, IncomingCallService.ServiceHandler handler) {
        m_handler=handler;
        if (ready) {
            Log.v("SMN", "ready: "+text);
            HashMap<String, String> map = new HashMap<String, String>();
            map.put(TextToSpeech.Engine.KEY_PARAM_UTTERANCE_ID, "UniqueID");
            talker.speak("."+"your getting a call from"+"."+ text+"."+"your getting a call from"+"."+ text+"."+"your getting a call from"+"."+ text+"."+"your getting a call from"+"."+ text+"."+"your getting a call from"+"."+ text+"."+"your getting a call from"+"."+ text+"."+"your getting a call from"+"."+ text, TextToSpeech.QUEUE_FLUSH, map);
        } else {
            do {
                synchronized (waitObject) {
                    try {
